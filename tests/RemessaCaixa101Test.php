...
use CnabPHP\resources\B104\remessa\cnab240_107\Registro1;
 ...
 * Remessa Test Case.
 *
 * @author Luizinho Gameplays <luizgustavobenicio@gmail.com>
 */
class RemessaCaixa101Test extends TestCase
{
    /**
     * The Remessa Object
     * 
    ...
    public function setUp()
    {
        ...
        $this->remessa = new Remessa(
            ...
            [
                ...
                'numero_inscricao' => '23.812.139/0001-35', // seu cpf ou cnpj completo
                ...
                'codigo_beneficiario'     => '339578', // codigo fornecido pelo banco
    ...
    public function inserirDetalhe()
    {
        $detalhe = [
            ...
            'numero_inscricao'  => '252.988.140-50',//cpf ou ncpj do pagador
